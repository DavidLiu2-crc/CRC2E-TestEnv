...
public sealed class KtVisa32
{
    ...
    public static extern int viKTMoveToPeer(int masterVi, int srcVi, short srcSpace, long srcOffset, int destVi, short destSpace, long destOffset, long length);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "viKTMoveToPeerAsync", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viKTMoveToPeerAsync(int masterVi, int srcVi, short srcSpace, long srcOffset, int destVi, short destSpace, long destOffset, long length, out int jobId);
