classdef RangeTable2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = RangeTable2(interface)
            ...
            try
                obj.Start = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.RangeTable2.Start(obj.interface.Start);
            catch %#ok<CTCH>
            end

            try
                obj.Stop = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.RangeTable2.Stop(obj.interface.Stop);
            catch %#ok<CTCH>
            end

            try
                obj.Bandwidth = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.RangeTable2.Bandwidth(obj.interface.Bandwidth);
            catch %#ok<CTCH>
            end
