classdef SpuriousEmissions2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = SpuriousEmissions2(interface)
            ...
            try
                obj.Display2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.Display2(obj.interface.Display2);
            catch %#ok<CTCH>
            end

            try
                obj.RangeTable2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.RangeTable2(obj.interface.RangeTable2);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.RangeTable = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2.RangeTable(obj.interface.RangeTable);
            catch %#ok<CTCH>
            end
