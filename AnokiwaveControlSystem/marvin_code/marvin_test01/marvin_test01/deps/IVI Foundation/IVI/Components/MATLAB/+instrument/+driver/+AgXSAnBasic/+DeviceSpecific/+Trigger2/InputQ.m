classdef InputQ < instrument.ivicom.Interface
    %INPUTQ IAgXSAnBasicTrigger2InputQ interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = InputQ(interface)
    ...
    properties
        ...
        %LEVEL A level for the Input Q trigger.
        Level
