classdef IQ < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = IQ(interface)
            ...
            try
                obj.Power = instrument.driver.AgXSAnBasic.DeviceSpecific.Input2.IQ.Power(obj.interface.Power);
            catch %#ok<CTCH>
            end

            try
                obj.Voltage = instrument.driver.AgXSAnBasic.DeviceSpecific.Input2.IQ.Voltage(obj.interface.Voltage);
            catch %#ok<CTCH>
            end
