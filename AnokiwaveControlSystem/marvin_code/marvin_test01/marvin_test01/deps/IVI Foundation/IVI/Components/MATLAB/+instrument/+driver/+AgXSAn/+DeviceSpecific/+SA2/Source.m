classdef Source < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Source(interface)
            ...
            try
                obj.Level = instrument.driver.AgXSAn.DeviceSpecific.SA2.Source.Level(obj.interface.Level);
            catch %#ok<CTCH>
            end

            try
                obj.Frequency = instrument.driver.AgXSAn.DeviceSpecific.SA2.Source.Frequency(obj.interface.Frequency);
            catch %#ok<CTCH>
            end
