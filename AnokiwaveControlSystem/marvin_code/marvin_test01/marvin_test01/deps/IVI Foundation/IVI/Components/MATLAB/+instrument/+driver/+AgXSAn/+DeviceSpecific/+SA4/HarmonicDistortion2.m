classdef HarmonicDistortion2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = HarmonicDistortion2(interface)
            ...
            try
                obj.Traces2 = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.Traces2(obj.interface.Traces2);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.RangeTable = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.RangeTable(obj.interface.RangeTable);
            catch %#ok<CTCH>
            end

            try
                obj.Tone = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.Tone(obj.interface.Tone);
            catch %#ok<CTCH>
            end

            try
                obj.DisplayWindowY = instrument.driver.AgXSAn.DeviceSpecific.SA4.HarmonicDistortion2.DisplayWindowY(obj.interface.DisplayWindowY);
            catch %#ok<CTCH>
            end
