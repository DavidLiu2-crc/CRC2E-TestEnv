classdef Average < instrument.ivicom.Interface
    %AVERAGE IAgXSAnSABurstPowerAverage interface.
    ...
    properties
        ...
        %COUNT The number of data acquisitions that will be averaged.
        Count

        %ENABLED Enables or disables the averaging function.
        Enabled

        %MODE The type of termination control used for the averaging function.
        Mode

        %TYPE The type of trace and result averaging to use.
        Type
