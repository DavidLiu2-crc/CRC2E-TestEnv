classdef ThirdOrderIntercept < instrument.ivicom.Interface
    %THIRDORDERINTERCEPT IAgXSAnSAThirdOrderIntercept interface
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = ThirdOrderIntercept(interface)
            ...
            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA2.ThirdOrderIntercept.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA2.ThirdOrderIntercept.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA2.ThirdOrderIntercept.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.ZeroSpanSweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA2.ThirdOrderIntercept.ZeroSpanSweepCoupling(obj.interface.ZeroSpanSweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.DisplayWindowY = instrument.driver.AgXSAn.DeviceSpecific.SA2.ThirdOrderIntercept.DisplayWindowY(obj.interface.DisplayWindowY);
            catch %#ok<CTCH>
            end
