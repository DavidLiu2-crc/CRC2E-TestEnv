classdef Average2 < instrument.ivicom.Interface
    %AVERAGE2 IAgXSAnBasicSpectrumAverage2 interface.
    ...
    properties
        ...
        %TIMEAVERAGECOUNT The number of hardware averages to be executed per data acquisition.
        TimeAverageCount
        ...
        %TYPEAUTOENABLED Enable or disable the auto averaging type.
        TypeAutoEnabled
    ...
    methods
        ...
        %% TimeAverageCount property access methods
        function value = get.TimeAverageCount(obj)
            obj.checkValidObj();
            try
                value = obj.interface.TimeAverageCount;
            catch e
                obj.interpretError(e);
            end
        end
		function set.TimeAverageCount(obj,newValue)
			obj.checkValidObj();
            newValue = obj.checkScalarInt32Arg(newValue,'TimeAverageCount');
            try
                obj.interface.TimeAverageCount = newValue;
            catch e
                obj.interpretError(e);
            end
        end
