classdef Item < instrument.ivicom.Interface
    %ITEM AgXSAn armalarm interface.
    ...
    properties
        ...
        %TIMESECONDS Specifies the seconds portion of time at which the alarm will go off.
        TimeSeconds

        %TIMEFRACTION Specifies the fractional portion of the time at which the alarm will go off.
        TimeFraction

        %PERIOD Specifies the period of the arm alarm in seconds; that is, the amount of time in seconds that transpire before the alarm repeats.
        Period

        %REPEATCOUNT Specifies the number of times to repeat the trigger at the period specified by the Arm Alarm Period attribute.
        RepeatCount

        %ENABLED Enables or disables the arm alarm.
        Enabled
    ...
    methods
        ...
        function Configure(obj,Enabled,TimeSeconds,TimeFraction,Period,RepeatCount)
            %CONFIGURE This function configures the most commonly configured attributes of the arm alarm sub-system.
            ...
            try
                obj.interface.Configure(logical(Enabled),double(TimeSeconds),double(TimeFraction),double(Period),int32(RepeatCount));
            catch e
                obj.interpretError(e);
            end
        end
