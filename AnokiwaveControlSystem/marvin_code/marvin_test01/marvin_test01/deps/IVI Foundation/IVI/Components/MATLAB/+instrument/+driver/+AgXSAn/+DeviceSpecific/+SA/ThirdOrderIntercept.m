classdef ThirdOrderIntercept < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ThirdOrderIntercept(interface)
            ...
            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA.ThirdOrderIntercept.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA.ThirdOrderIntercept.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA.ThirdOrderIntercept.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.ZeroSpanSweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA.ThirdOrderIntercept.ZeroSpanSweepCoupling(obj.interface.ZeroSpanSweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.DisplayWindowY = instrument.driver.AgXSAn.DeviceSpecific.SA.ThirdOrderIntercept.DisplayWindowY(obj.interface.DisplayWindowY);
            catch %#ok<CTCH>
            end
