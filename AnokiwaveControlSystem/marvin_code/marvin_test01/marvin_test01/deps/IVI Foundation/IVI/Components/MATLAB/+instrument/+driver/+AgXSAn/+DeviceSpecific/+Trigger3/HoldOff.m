classdef HoldOff < instrument.ivicom.Interface
    %HOLDOFF IAgXSAnTrigger3HoldOff interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = HoldOff(interface)
    ...
    properties
        ...
        %TIME The holdoff time between triggers.
        Time

        %ENABLED Enable or disable holdoff time state.
        Enabled
