classdef ListSweep < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ListSweep(interface)
            ...
            try
                obj.Bandwidth = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Bandwidth(obj.interface.Bandwidth);
            catch %#ok<CTCH>
            end

            try
                obj.Frequency = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Frequency(obj.interface.Frequency);
            catch %#ok<CTCH>
            end

            try
                obj.Sequence = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Sequence(obj.interface.Sequence);
            catch %#ok<CTCH>
            end

            try
                obj.Trigger = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Trigger(obj.interface.Trigger);
            catch %#ok<CTCH>
            end

            try
                obj.Time = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Time(obj.interface.Time);
            catch %#ok<CTCH>
            end

            try
                obj.Detector = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Detector(obj.interface.Detector);
            catch %#ok<CTCH>
            end

            try
                obj.Attenuation = instrument.driver.AgXSAn.DeviceSpecific.SA4.ListSweep.Attenuation(obj.interface.Attenuation);
            catch %#ok<CTCH>
            end
