classdef Offset < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Offset(interface)
            ...
            try
                obj.Filter = instrument.driver.AgXSAn.DeviceSpecific.SA3.SEMask.Offset.Filter(obj.interface.Filter);
            catch %#ok<CTCH>
            end

            try
                obj.List = instrument.driver.AgXSAn.DeviceSpecific.SA3.SEMask.Offset.List(obj.interface.List);
            catch %#ok<CTCH>
            end
