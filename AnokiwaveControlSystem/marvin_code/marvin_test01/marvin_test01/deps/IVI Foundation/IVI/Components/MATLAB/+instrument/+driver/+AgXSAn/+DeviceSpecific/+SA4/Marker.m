classdef Marker < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Marker(interface)
            ...
            try
                obj.FrequencyCounter = instrument.driver.AgXSAn.DeviceSpecific.SA4.Marker.FrequencyCounter(obj.interface.FrequencyCounter);
            catch %#ok<CTCH>
            end

            try
                obj.NDBPoints = instrument.driver.AgXSAn.DeviceSpecific.SA4.Marker.NDBPoints(obj.interface.NDBPoints);
            catch %#ok<CTCH>
            end

            try
                obj.MeasureAtMarker = instrument.driver.AgXSAn.DeviceSpecific.SA4.Marker.MeasureAtMarker(obj.interface.MeasureAtMarker);
            catch %#ok<CTCH>
            end
