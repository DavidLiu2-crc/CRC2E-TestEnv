classdef ACP < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ACP(interface)
            ...
            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.Carrier = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Carrier(obj.interface.Carrier);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.Frequency = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Frequency(obj.interface.Frequency);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Offset = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP.Offset(obj.interface.Offset);
            catch %#ok<CTCH>
            end
