classdef Item < instrument.ivicom.Interface
    ...
    properties
        ...
        %TYPE Changes the reference used for the measurement. This allows you to make absolute and relative power measurements of either total power or the power normalized to the measurement bandwidth.
        Type
