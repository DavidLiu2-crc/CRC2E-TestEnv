classdef Offset < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Offset(interface)
            ...
            try
                obj.List = instrument.driver.AgXSAn.DeviceSpecific.SA2.ACP.Offset.List(obj.interface.List);
            catch %#ok<CTCH>
            end

            try
                obj.Filter = instrument.driver.AgXSAn.DeviceSpecific.SA2.ACP.Offset.Filter(obj.interface.Filter);
            catch %#ok<CTCH>
            end
