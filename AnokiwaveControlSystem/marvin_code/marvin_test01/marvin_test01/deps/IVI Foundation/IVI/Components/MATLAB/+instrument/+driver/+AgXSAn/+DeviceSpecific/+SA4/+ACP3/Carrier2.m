classdef Carrier2 < instrument.ivicom.Interface
    %CARRIER2 IAgXSAnSAACPCarrier2 interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = Carrier2(interface)
            ...
            try
                obj.List2 = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP3.Carrier2.List2(obj.interface.List2);
            catch %#ok<CTCH>
            end

            try
                obj.List = instrument.driver.AgXSAn.DeviceSpecific.SA4.ACP3.Carrier2.List(obj.interface.List);
            catch %#ok<CTCH>
            end
