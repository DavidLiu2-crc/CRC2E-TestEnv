classdef SEMask2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = SEMask2(interface)
            ...
            try
                obj.Display2 = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Display2(obj.interface.Display2);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling2 = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.SweepCoupling2(obj.interface.SweepCoupling2);
            catch %#ok<CTCH>
            end

            try
                obj.Offset2 = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2(obj.interface.Offset2);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.ReferenceChannel = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.ReferenceChannel(obj.interface.ReferenceChannel);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.Offset = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset(obj.interface.Offset);
            catch %#ok<CTCH>
            end
