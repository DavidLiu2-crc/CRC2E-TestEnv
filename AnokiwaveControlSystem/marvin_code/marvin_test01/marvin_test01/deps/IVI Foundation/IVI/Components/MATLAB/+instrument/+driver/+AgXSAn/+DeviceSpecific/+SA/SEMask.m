classdef SEMask < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = SEMask(interface)
            ...
            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.ReferenceChannel = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.ReferenceChannel(obj.interface.ReferenceChannel);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.Offset = instrument.driver.AgXSAn.DeviceSpecific.SA.SEMask.Offset(obj.interface.Offset);
            catch %#ok<CTCH>
            end
