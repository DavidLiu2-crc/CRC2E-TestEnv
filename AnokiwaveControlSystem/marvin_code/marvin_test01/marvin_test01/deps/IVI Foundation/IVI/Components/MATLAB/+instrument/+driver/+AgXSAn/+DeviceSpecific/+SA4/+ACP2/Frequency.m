classdef Frequency < instrument.ivicom.Interface
    %FREQUENCY IAgXSAn SAACPFrequency interface.
    ...
    properties
        ...
        %PHASENOISEOPTIONAUTOENABLED The best LO (local oscillator) phase noise behavior for the ACP measurement.
        PhaseNoiseOptionAutoEnabled

        %PHASENOISEOPTIONSTATE The LO (local oscillator) phase noise behavior for various operating conditions.
        PhaseNoiseOptionState

        %SPAN The frequency range about the center frequency.
        Span
