classdef ChannelPower < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ChannelPower(interface)
            ...
            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.Frequency = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.Frequency(obj.interface.Frequency);
            catch %#ok<CTCH>
            end

            try
                obj.OffsetFilter = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.OffsetFilter(obj.interface.OffsetFilter);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA2.ChannelPower.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end
