classdef Display2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Display2(interface)
            ...
            try
                obj.WindowX = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Display2.WindowX(obj.interface.WindowX);
            catch %#ok<CTCH>
            end

            try
                obj.WindowY = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Display2.WindowY(obj.interface.WindowY);
            catch %#ok<CTCH>
            end
