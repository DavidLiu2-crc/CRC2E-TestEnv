classdef DisplayWindowY < instrument.ivicom.Interface
    %DISPLAYWINDOWY IAgXSAnSAThirdOrderInterceptDisplayWindowY interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = DisplayWindowY(interface)
