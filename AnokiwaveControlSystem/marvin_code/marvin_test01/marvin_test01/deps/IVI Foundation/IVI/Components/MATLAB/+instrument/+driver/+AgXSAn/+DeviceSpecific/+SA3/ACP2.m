classdef ACP2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ACP2(interface)
            ...
            try
                obj.Carrier2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Carrier2(obj.interface.Carrier2);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.Carrier = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Carrier(obj.interface.Carrier);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.Frequency = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Frequency(obj.interface.Frequency);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Offset = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2.Offset(obj.interface.Offset);
            catch %#ok<CTCH>
            end
