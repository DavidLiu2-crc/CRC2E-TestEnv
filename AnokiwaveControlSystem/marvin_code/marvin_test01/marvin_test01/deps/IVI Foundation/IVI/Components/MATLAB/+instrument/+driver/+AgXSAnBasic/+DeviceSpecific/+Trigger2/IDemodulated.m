classdef IDemodulated < instrument.ivicom.Interface
    %IDEMODULATED IAgXSAnBasicTrigger2IDemodulated interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = IDemodulated(interface)
    ...
    properties
        ...
        %LEVEL A level for the I (Demodulated) trigger.
        Level
