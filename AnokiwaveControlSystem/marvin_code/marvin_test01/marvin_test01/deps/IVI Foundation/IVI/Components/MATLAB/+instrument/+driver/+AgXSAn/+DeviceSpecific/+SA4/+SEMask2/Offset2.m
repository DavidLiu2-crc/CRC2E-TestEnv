classdef Offset2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Offset2(interface)
            ...
            try
                obj.List2 = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2.List2(obj.interface.List2);
            catch %#ok<CTCH>
            end

            try
                obj.Filter = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2.Filter(obj.interface.Filter);
            catch %#ok<CTCH>
            end

            try
                obj.List = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2.List(obj.interface.List);
            catch %#ok<CTCH>
            end
