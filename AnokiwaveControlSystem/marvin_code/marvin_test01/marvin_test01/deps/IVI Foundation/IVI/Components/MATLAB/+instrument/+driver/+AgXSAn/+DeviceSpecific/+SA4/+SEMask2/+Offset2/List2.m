classdef List2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = List2(interface)
            ...
            try
                obj.Bandwidth = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2.List2.Bandwidth(obj.interface.Bandwidth);
            catch %#ok<CTCH>
            end

            try
                obj.Start = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2.List2.Start(obj.interface.Start);
            catch %#ok<CTCH>
            end

            try
                obj.Stop = instrument.driver.AgXSAn.DeviceSpecific.SA4.SEMask2.Offset2.List2.Stop(obj.interface.Stop);
            catch %#ok<CTCH>
            end
