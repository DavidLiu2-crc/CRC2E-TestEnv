classdef Marker < instrument.ivicom.Interface
    %MARKER IAgXSAnSASpuriousEmissionsMarker interface.
    ...
    properties
        ...
        %CONTINUOUSPEAKSEARCHENABLED Turns Continuous Peak Search On or Off. When Continuous Peak Search is on, a peak search is automatically performed for the selected marker after each sweep.
        ContinuousPeakSearchEnabled

        %TRACEPOINTSPOSITION Marker X postion value.
        TracePointsPosition
