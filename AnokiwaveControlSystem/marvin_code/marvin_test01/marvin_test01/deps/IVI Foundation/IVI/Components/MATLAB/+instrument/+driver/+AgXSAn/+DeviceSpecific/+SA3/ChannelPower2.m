classdef ChannelPower2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ChannelPower2(interface)
            ...
            try
                obj.Traces2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.Traces2(obj.interface.Traces2);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.Frequency = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.Frequency(obj.interface.Frequency);
            catch %#ok<CTCH>
            end

            try
                obj.OffsetFilter = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.OffsetFilter(obj.interface.OffsetFilter);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.Display = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.Display(obj.interface.Display);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end
