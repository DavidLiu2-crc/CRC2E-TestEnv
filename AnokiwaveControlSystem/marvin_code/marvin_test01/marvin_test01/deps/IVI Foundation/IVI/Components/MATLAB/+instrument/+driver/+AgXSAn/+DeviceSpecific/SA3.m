classdef SA3 < instrument.ivicom.Interface
    %SA3 IAgXSAnSA3 interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = SA3(interface)
            ...
            try
                obj.SEMask2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.SEMask2(obj.interface.SEMask2);
            catch %#ok<CTCH>
            end

            try
                obj.SpuriousEmissions2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions2(obj.interface.SpuriousEmissions2);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.SweepCoupling2(obj.interface.SweepCoupling2);
            catch %#ok<CTCH>
            end

            try
                obj.OccupiedBandwidth2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.OccupiedBandwidth2(obj.interface.OccupiedBandwidth2);
            catch %#ok<CTCH>
            end

            try
                obj.ACP2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP2(obj.interface.ACP2);
            catch %#ok<CTCH>
            end

            try
                obj.ChannelPower2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower2(obj.interface.ChannelPower2);
            catch %#ok<CTCH>
            end

            try
                obj.BurstPower2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.BurstPower2(obj.interface.BurstPower2);
            catch %#ok<CTCH>
            end

            try
                obj.HarmonicDistortion2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.HarmonicDistortion2(obj.interface.HarmonicDistortion2);
            catch %#ok<CTCH>
            end

            try
                obj.ThirdOrderIntercept2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept2(obj.interface.ThirdOrderIntercept2);
            catch %#ok<CTCH>
            end

            try
                obj.Gating2 = instrument.driver.AgXSAn.DeviceSpecific.SA3.Gating2(obj.interface.Gating2);
            catch %#ok<CTCH>
            end

            try
                obj.Source = instrument.driver.AgXSAn.DeviceSpecific.SA3.Source(obj.interface.Source);
            catch %#ok<CTCH>
            end

            try
                obj.ACP = instrument.driver.AgXSAn.DeviceSpecific.SA3.ACP(obj.interface.ACP);
            catch %#ok<CTCH>
            end

            try
                obj.BurstPower = instrument.driver.AgXSAn.DeviceSpecific.SA3.BurstPower(obj.interface.BurstPower);
            catch %#ok<CTCH>
            end

            try
                obj.ChannelPower = instrument.driver.AgXSAn.DeviceSpecific.SA3.ChannelPower(obj.interface.ChannelPower);
            catch %#ok<CTCH>
            end

            try
                obj.OccupiedBandwidth = instrument.driver.AgXSAn.DeviceSpecific.SA3.OccupiedBandwidth(obj.interface.OccupiedBandwidth);
            catch %#ok<CTCH>
            end

            try
                obj.PowerStatistics = instrument.driver.AgXSAn.DeviceSpecific.SA3.PowerStatistics(obj.interface.PowerStatistics);
            catch %#ok<CTCH>
            end

            try
                obj.SEMask = instrument.driver.AgXSAn.DeviceSpecific.SA3.SEMask(obj.interface.SEMask);
            catch %#ok<CTCH>
            end

            try
                obj.SpuriousEmissions = instrument.driver.AgXSAn.DeviceSpecific.SA3.SpuriousEmissions(obj.interface.SpuriousEmissions);
            catch %#ok<CTCH>
            end

            try
                obj.HarmonicDistortion = instrument.driver.AgXSAn.DeviceSpecific.SA3.HarmonicDistortion(obj.interface.HarmonicDistortion);
            catch %#ok<CTCH>
            end

            try
                obj.ThirdOrderIntercept = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept(obj.interface.ThirdOrderIntercept);
            catch %#ok<CTCH>
            end

            try
                obj.Gating = instrument.driver.AgXSAn.DeviceSpecific.SA3.Gating(obj.interface.Gating);
            catch %#ok<CTCH>
            end

            try
                obj.Limits = instrument.driver.AgXSAn.DeviceSpecific.SA3.Limits(obj.interface.Limits);
            catch %#ok<CTCH>
            end

            try
                obj.ListSweep = instrument.driver.AgXSAn.DeviceSpecific.SA3.ListSweep(obj.interface.ListSweep);
            catch %#ok<CTCH>
            end

            try
                obj.Marker = instrument.driver.AgXSAn.DeviceSpecific.SA3.Marker(obj.interface.Marker);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA3.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.SweptSAs = instrument.driver.AgXSAn.DeviceSpecific.SA3.SweptSAs(obj.interface.SweptSAs);
            catch %#ok<CTCH>
            end
