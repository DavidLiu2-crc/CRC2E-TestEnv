classdef Display < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = Display(interface)
            ...
            try
                obj.WindowX = instrument.driver.AgXSAn.DeviceSpecific.SA3.BurstPower.Display.WindowX(obj.interface.WindowX);
            catch %#ok<CTCH>
            end

            try
                obj.WindowY = instrument.driver.AgXSAn.DeviceSpecific.SA3.BurstPower.Display.WindowY(obj.interface.WindowY);
            catch %#ok<CTCH>
            end
