classdef Traces < instrument.ivicom.RepeatedCapability
    %TRACES IAgXSAnSAOccupiedBandwidth trace collection interface.
    ...
    methods
        ...
        function val = Item(obj,Name)
            ...
            try
                [val] = instrument.driver.AgXSAn.DeviceSpecific.SA3.OccupiedBandwidth2.Traces.Item(obj.interface.Item(char(Name)));
            catch e
                obj.interpretError(e);
            end
        end
