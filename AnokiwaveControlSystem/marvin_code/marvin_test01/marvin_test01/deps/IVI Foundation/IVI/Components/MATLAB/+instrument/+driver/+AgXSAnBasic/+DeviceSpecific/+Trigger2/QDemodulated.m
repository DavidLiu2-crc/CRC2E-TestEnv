classdef QDemodulated < instrument.ivicom.Interface
    %QDEMODULATED IAgXSAnBasicTrigger2QDemodulated interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = QDemodulated(interface)
    ...
    properties
        ...
        %LEVEL A level for the Q (Demodulated) trigger.
        Level
