classdef Display < instrument.ivicom.Interface
    %DISPLAY IAgXSAnSAChannelPowerDisplay interface.
    ...
    methods (Hidden=true)
        ...
        function obj = Display(interface)
            ...
            try
                obj.WindowY = instrument.driver.AgXSAn.DeviceSpecific.SA4.ChannelPower2.Display.WindowY(obj.interface.WindowY);
            catch %#ok<CTCH>
            end
    ...
    properties (SetAccess = private)
        ...
        %WINDOWY Pointer to IAgXSAnSAChannelPowerDisplayWindowY interface. Read Only.
        WindowY
