classdef Average < instrument.ivicom.Interface
    %AVERAGE IAgXSAn SAACPAverage interface.
    ...
    properties
        ...
        %COUNT The number of measurement averages used to calculate the measurement result. The average is available at the end of each sweep. After the specified number of average counts, the average mode setting determines the average action.
        Count

        %ENABLED Enable or disable the averaging.
        Enabled

        %MODE The averaging mode. This determines the averaging action after the specified number of data acquisitions (average count) is reached.
        Mode
