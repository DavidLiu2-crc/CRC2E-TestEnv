classdef Voltage < instrument.ivicom.Interface
    %VOLTAGE IAgXSAnBasicInputIQVoltage interface.
    
    %% Construction/Clean up
    methods (Hidden=true)

        function obj = Voltage(interface)
    ...
    properties
        ...
        %IMAX The internal voltage gain range for the I channel when Input Path is I Only or Ind I/Q, and it is used for both the I and Q channels when the Input Path is I+jQ.
        IMax

        %QMAX The internal voltage gain range for the Q channel.
        QMax
