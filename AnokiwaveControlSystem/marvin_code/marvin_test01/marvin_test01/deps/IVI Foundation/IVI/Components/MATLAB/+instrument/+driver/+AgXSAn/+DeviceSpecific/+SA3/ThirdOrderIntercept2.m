classdef ThirdOrderIntercept2 < instrument.ivicom.Interface
    ...
    methods (Hidden=true)
        ...
        function obj = ThirdOrderIntercept2(interface)
            ...
            try
                obj.Average = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept2.Average(obj.interface.Average);
            catch %#ok<CTCH>
            end

            try
                obj.SweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept2.SweepCoupling(obj.interface.SweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.Traces = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept2.Traces(obj.interface.Traces);
            catch %#ok<CTCH>
            end

            try
                obj.ZeroSpanSweepCoupling = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept2.ZeroSpanSweepCoupling(obj.interface.ZeroSpanSweepCoupling);
            catch %#ok<CTCH>
            end

            try
                obj.DisplayWindowY = instrument.driver.AgXSAn.DeviceSpecific.SA3.ThirdOrderIntercept2.DisplayWindowY(obj.interface.DisplayWindowY);
            catch %#ok<CTCH>
            end
