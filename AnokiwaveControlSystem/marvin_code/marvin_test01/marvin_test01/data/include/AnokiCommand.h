...
public:
	...
	void set_PointingFreq(unsigned int _freq);
	...
	bool read_commandResponse(unsigned char* pReadByte, unsigned char _numBytesRead, AnokiObj anokiobj);
...
private:
	...
	unsigned int paramFrequency = 28000;	// Frequency [27500 - 30000] MHz;
	...
	void freq_uint16ToPointer(unsigned int value, unsigned char* pnSequence);
