...
/** The available color processing/destippling/demosaicing methods. */
    ...
    public enum LadybugPixelFormat
    {
        ...
        // TODO: Remove user-added enumerations for RGB
    ...
    {        
        ...
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugConvertImageGPU", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError ConvertImageGPU(
                    IntPtr context,
                    ref LadybugImage pImage,
                    byte** arpDestBuffers,
                    LadybugPixelFormat pixelFormat = LadybugPixelFormat.LADYBUG_UNSPECIFIED_PIXEL_FORMAT);
