...
namespace LadybugAPI
{
    ...
    unsafe public struct LadybugImageRenderingInfo
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("Memory size: ").Append(this.uiMemorySize).Append(" MB\n");
    ...
    unsafe public partial class Ladybug
    {
        ...
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugUpdateTexturesGPU", CallingConvention = CallingConvention.Cdecl)]
        public static extern LadybugError UpdateTexturesGPU(
              IntPtr context,
              uint uiCameras,
              byte** arpBGRABuffers,
              LadybugPixelFormat pixelFormat);
